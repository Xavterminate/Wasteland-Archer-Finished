...
function draw(){
   ...
   text("Health:"+health,player.position.x,player.position.y-100);
    ...
    if(player.position.y>7900&&shipParts<25){
        gamestate=3;
    }
    if(player.position.y>7900&&shipParts>=25){
        gamestate=4;
    ...
    if(gamestate===2){
        text("You lose, you died",player.position.x,player.position.y-30)
    }
    if(gamestate===3){
        text("You lose, stranded",player.position.x,player.position.y-30)
    }
    if(gamestate===4){
        text("You win, escape achieved",player.position.x,player.position.y-30);
    }
}
